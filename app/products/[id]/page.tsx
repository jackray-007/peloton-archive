...
import { ShoppingCart, Heart, Share2, Check, Truck, Shield, ArrowLeft, ZoomIn, Facebook, Twitter } from 'lucide-react';
import { getProductById, getProductsByTeam, getProductsByCategory } from '@/lib/products';
...
export default function ProductDetailPage() {
  ...
  useEffect(() => {
    if (product && id) {
      // Only add if product exists and is valid
      addToRecentlyViewed(product);
    }
  // Only depend on id, not the function
